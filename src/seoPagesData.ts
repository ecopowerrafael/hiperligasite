...
export const SEO_PAGES_DATA: Record<string, SEOPageContent> = {
  ...
  'comprar-argamassa-polimerica': {
    ...
    steps: [
      ...
      { step: '2', title: 'Selecione as Embalagens', desc: 'Acesse loja.hiperliga.com.br, selecione as embalagens entre a bisnaga de 3kg ou barricas volumétricas industriais.' },
